...
export default function CopaDoBrasil() {
  ...
  const sofascoreUrl =
    "https://www.sofascore.com/pt/torneio/futebol/brazil/copa-do-brasil/373#id:71944";
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Copa do Brasil 2025</Text>
        ...
        <View style={styles.widgetContainer}>
          <WebView
            ref={webViewRef}
            source={{
              uri: "https://widgets.sofascore.com/pt-BR/embed/unique-tournament/373/season/71944/cuptree/10570627?widgetTitle=Copa do Brasil 2025&showCompetitionLogo=true&widgetTheme=light",
            }}
        ...
        <View style={styles.footerInfo}>
          <Text style={styles.footerText}>
            Fase eliminatória da Copa do Brasil 2025
          </Text>
          <Text style={styles.footerText}>
...
const styles = StyleSheet.create({
  ...
  widgetContainer: {
    height: 700, // Altura ajustada para o widget do chaveamento da Copa do Brasil
